...
Due Mar 24 by 11:59pm | Points 20 | Submitting a file upload | Available until Mar 26 at 11:59pm

---

## Overview

You are developing a management system for a zoo to ensure that animals receive timely care and attention.
The zoo has three types of care facilities with different care capacities: Basic, Advanced, and Intensive.
To manage the animals effectively, you will implement a combination of hash tables and binary search trees (BST).
...
Implement a hash table (dictionary insufficient) to store and quickly access animals by their unique names.
...
4. **Testing**:
    ...
    - Demonstrate insertion, deletion, periodic care-level increases, and efficient retrieval of animals based on
