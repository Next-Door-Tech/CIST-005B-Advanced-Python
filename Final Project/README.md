...
For the completed ***interactive*** report, please run `report.py` in the Report directory.

## Data Structures

The Graph data structure is built upon a bunch of custom dictionaries, implemented as hash tables (HashMap). The HashMap
structure itself contains a LinkedList to keep track of insertion order.
